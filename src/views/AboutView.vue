    ...
    <div class="mt-12">
      <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
        <div
          ...
          <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">About
            Us</h6>
        </div>
                ...
                <div class="flex justify-center">
                  <div class="grid grid-cols-3 gap-4">
                    <div
                      ...
                      <div class="border-t border-blue-gray-50 p-4">
                        <p
                          class="block text-center antialiased font-sans text-sm mb-4 leading-normal font-semibold uppercase text-blue-gray-600">
                          Step One</p>
                        <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi eos eum optio hic exercitationem
                          voluptate dolorum debitis quo facilis consequuntur praesentium officia nesciunt quas, totam
